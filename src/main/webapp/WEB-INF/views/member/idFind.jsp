...
<meta charset="UTF-8">
<title>CafeDal</title>
<link type="text/css" rel="stylesheet" href="${path}/resource/css/idpwdfindstyle.css">
</head>
...
<section class="container">
		    <article class="half">
			        ...
			        <div class="tabs">
				            ...
				            <span class="tab signup"><a href="${path}/member/idpwdFind#signup">비밀번호 찾기</a></span>
			        </div>
			        <div class="content">
				            <div class="signin-cont cont">
					                <form>
						                    <h4 style="padding:40px; text-align: center;">${list.name}님의 아이디는</h4><br/><h4 id="red">${list.id}</h4><h4 style="text-align: center;">입니다.</h4>             						 
    				        ...
    				        <%-- <div class="signup-cont cont">
              						<form action="pwdFind?${_csrf.parameterName}=${_csrf.token}" method="get">
						                    ...
						                    <input type="text" name="name" id="name" class="inpt" required="required" placeholder="이름을 입력하세요">			                  
                   							 <input type="email" name="mail" id="mail" class="inpt" required="required" placeholder="이메일을 입력하세요">
