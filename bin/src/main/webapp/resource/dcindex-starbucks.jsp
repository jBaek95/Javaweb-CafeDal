							...
							<article class="post">
								<header>
									...
									<div class="meta">
										...
										<a href="#" class="author"><span class="name">Starbucks</span><img src="images/logo-star.png" alt="" /></a>
									</div>
								</header>
								<img class="image featured" src="images/b-star1.PNG" alt="" style="width:820px ; height: 370px" />
								<p>- 미판매 매장: 인천공항 입국/출국/중앙, 오션월드 입구, 설악 워터피아
